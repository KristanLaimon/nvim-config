...
function PANEL:AddItem(left, right) end
...
function PANEL:Button(text, concommand, ...) end
...
function PANEL:CheckBox(label, convar) end
...
function PANEL:ComboBox(title, convar) end
...
--- @return GPanel @The created DLabel
function PANEL:ListBox(label) end
...
function PANEL:NumSlider(label, convar, min, max, decimals) end
...
--- @return GPanel @The created DLabel
function PANEL:NumberWang(label, convar, min, max, decimals) end
...
function PANEL:PanelSelect() end
...
function PANEL:PropSelect(label, convar, models, height) end
...
--- an Global.AccessorFunc that does nothing
--- @param arg boolean
function PANEL:SetAutoSize(arg) end
...
--- An Global.AccessorFunc that does nothing.
--- @param arg number
function PANEL:SetSpacing(arg) end
...
--- @return GPanel @The created DLabel
function PANEL:TextEntry(label, convar) end

...
function PANEL:GetBaseFolder() end
...
function PANEL:GetCurrentFolder() end
...
function PANEL:GetFileTypes() end
...
function PANEL:GetFolderNode() end
...
function PANEL:OnDoubleClick(selectedPanel, filePath) end
...
function PANEL:OnRightClick(filePath, selectedPanel) end
...
function PANEL:OnSelect(selectedPanel, filePath) end
...
function PANEL:SetBaseFolder(baseDir) end
...
function PANEL:SetCurrentFolder(currentDir) end
...
function PANEL:SetFileTypes(fileTypes) end
...
function PANEL:SetModels(showModels) end
...
function PANEL:SetName(treeName) end
...
function PANEL:SetOpen(open, useAnim) end
...
function PANEL:SetPath(path) end
...
function PANEL:SetSearch(filter) end
...
function PANEL:SortFiles(descending) end

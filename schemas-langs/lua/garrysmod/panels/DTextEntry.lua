...
function PANEL:AddHistory(text) end
...
function PANEL:AllowInput(char) end
...
function PANEL:CheckNumeric(strValue) end
...
function PANEL:GetDisabled() end
...
--- @return boolean
function PANEL:GetDrawBackground() end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Returns the value set by DTextEntry:SetDrawBorder.
--- @return boolean
function PANEL:GetDrawBorder() end
...
function PANEL:GetEnterAllowed() end
...
function PANEL:GetHighlightColor() end
...
function PANEL:GetHistoryEnabled() end
...
--- @return boolean
function PANEL:GetUpdateOnType() end
...
function PANEL:OnKeyCode(keyCode) end
...
function PANEL:SetCursorColor(color) end
...
function PANEL:SetDisabled(disabled) end

--- @deprecated
--- 🛑 **DEPRECATED**:
---  Alias of DTextEntry:SetPaintBackground. Use that instead.
--- @param show boolean
function PANEL:SetDrawBackground(show) end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Does nothing.
--- @param bool boolean
function PANEL:SetDrawBorder(bool) end
...
function PANEL:SetEditable(enabled) end
...
function PANEL:SetHighlightColor(color) end
...
function PANEL:SetHistoryEnabled(enable) end
...
function PANEL:SetNumeric(numericOnly) end
...
function PANEL:SetPaintBackground(show) end

--- Allow you to set placeholder color.
--- @param color? table @The color of the placeholder.
function PANEL:SetPlaceholderColor(color) end
...
--- @param text? string
function PANEL:SetPlaceholderText(text) end
...
function PANEL:SetTabbingDisabled(enabled) end

--- Sets the text color of the DTextEntry.
--- @param color table @The text color
function PANEL:SetTextColor(color) end
...
function PANEL:SetUpdateOnType(updateOnType) end
...
function PANEL:SetValue(text) end

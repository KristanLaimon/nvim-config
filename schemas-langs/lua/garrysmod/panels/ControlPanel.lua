...
function PANEL:ColorPicker(label, convarR, convarG, convarB, convarA) end

--- Sets control values of the control panel.
--- @param data table @A two-membered table:
function PANEL:ControlValues(data) end
...
function PANEL:KeyBinder(label1, convar1, label2, convar2) end
...
function PANEL:MatSelect(convar, options, autostretch, width, height) end
...
function PANEL:ToolPresets(group, cvarList) end

...
function PANEL:GetColumnID() end
...
function PANEL:GetTextAlign() end
...
function PANEL:ResizeColumn(size) end
...
function PANEL:SetDescending(desc) end
...
function PANEL:SetTextAlign(alignment) end

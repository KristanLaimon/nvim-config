...
function PANEL:LayoutEntity(entity) end
...
function PANEL:PreDrawModel(ent) end
...
function PANEL:SetAnimSpeed(animSpeed) end
...
function PANEL:SetAnimated(animated) end

--- Sets the position of the camera.
--- @param pos GVector @The position to set the camera at.
function PANEL:SetCamPos(pos) end
...
function PANEL:SetDirectionalLight(direction, color) end
...
function PANEL:SetLookAt(pos) end

...
function PANEL:AddFolder(name, folder, path, showFiles, wildcard, bDontForceExpandable) end
...
function PANEL:AddNode(name, icon) end
...
--- @return boolean
function PANEL:GetForceShowExpander() end
...
function PANEL:GetHideExpander() end

--- Returns the image path to the icon of this node.
--- @return string @The path to the image
function PANEL:GetIcon() end
...
function PANEL:GetIndentSize() end
...
function PANEL:GetLastChild() end
...
function PANEL:GetParentNode() end
...
function PANEL:Insert(node, nodeNextTo, before) end
...
function PANEL:LeaveTree(pnl) end
...
function PANEL:MakeFolder(folder, path, showFiles, wildcard, dontForceExpandable) end
...
function PANEL:MoveChildTo(node) end

--- Moves this node to the top of the level.
function PANEL:MoveToTop() end
...
function PANEL:OnNodeAdded(newNode) end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Appears to have no effect on the DTree_Node.
--- @param dirty boolean
function PANEL:SetDirty(dirty) end

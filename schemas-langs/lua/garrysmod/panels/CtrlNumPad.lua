...
function PANEL:GetValue1() end

--- The value (key bind) of the second DBinder, if it's enabled.
--- @return EKEY @The key bind or `KEY_NONE`.
function PANEL:GetValue2() end
...
function PANEL:SetConVar1(cvar) end

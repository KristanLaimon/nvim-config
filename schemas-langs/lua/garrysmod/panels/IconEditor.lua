...
function PANEL:AboveLayout() end
...
function PANEL:BestGuessLayout() end
...
function PANEL:FullFrontalLayout() end
...
function PANEL:OriginLayout() end
...
function PANEL:RightLayout() end
...
function PANEL:SetFromEntity(ent) end
...
function PANEL:SetIcon(icon) end

...
function PANEL:AddModel(model, convars) end
...
function PANEL:AddModelEx(value, model, skin) end
...
function PANEL:FindAndSelectButton(mdl) end
...
function PANEL:FindModelByValue(mdl) end
...
function PANEL:OnSelect(pnl, model) end

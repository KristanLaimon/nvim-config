...
function PANEL:GetRowHeight() end
...
function PANEL:SetCols(cols) end

--- Sets the height of each row.
--- The cell panels (grid items) will not be resized or centered.
--- @param rowHeight number @The height of each row
function PANEL:SetRowHeight(rowHeight) end
...
function PANEL:SortByMember(key, desc) end

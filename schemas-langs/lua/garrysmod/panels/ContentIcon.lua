...
function PANEL:GetContentType() end
...
function PANEL:GetNPCWeapon() end
...
function PANEL:GetSpawnName() end
...
function PANEL:SetAdminOnly(adminOnly) end
...
function PANEL:SetNPCWeapon(weapons) end
...
function PANEL:SetSpawnName(name) end

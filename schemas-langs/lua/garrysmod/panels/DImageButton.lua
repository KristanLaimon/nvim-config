...
function PANEL:SetDepressImage(enable) end
...
function PANEL:SetImage(strImage, strBackup) end
...
function PANEL:SetImageVisible(visible) end
...
function PANEL:SetStretchToFit(stretch) end

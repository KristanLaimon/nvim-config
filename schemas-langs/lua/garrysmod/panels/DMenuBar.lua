...
function PANEL:AddMenu(label) end
...
function PANEL:AddOrGetMenu(label) end
...
function PANEL:GetOpenMenu() end
...
function PANEL:SetDrawBackground(shouldPaint) end
...
--- @param shouldPaint boolean @Should the background be painted
function PANEL:SetPaintBackground(shouldPaint) end

...
function PANEL:AddFunction(library, name, callback) end
...
function PANEL:GetAllowLua() end
...
function PANEL:GetScrollbars() end
...
--- @param js string @Specify JavaScript code to be executed.
function PANEL:QueueJavascript(js) end
...
function PANEL:SetAllowLua(allow) end
...
function PANEL:SetScrollbars(show) end

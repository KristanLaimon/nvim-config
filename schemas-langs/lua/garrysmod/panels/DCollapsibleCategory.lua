...
function PANEL:GetAnimTime() end
...
--- @return number
function PANEL:GetStartHeight() end
...
function PANEL:SetAnimTime(time) end
...
function PANEL:SetContents(pnl) end
...
function PANEL:SetExpanded(expanded) end
...
function PANEL:SetLabel(label) end
...
function PANEL:SetList(pnl) end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Doesn't actually do anything.
--- @param padding number
function PANEL:SetPadding(padding) end
...
--- Does nothing.
--- @param height number
function PANEL:SetStartHeight(height) end

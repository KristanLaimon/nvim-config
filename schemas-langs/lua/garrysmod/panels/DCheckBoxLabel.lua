...
function PANEL:OnChange(bVal) end
...
function PANEL:SetChecked(checked) end
...
function PANEL:SetDark(darkify) end
...
function PANEL:SetIndent(ident) end
...
function PANEL:SetValue(checked) end

...
function PANEL:SetDecimals(num) end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Appears to do nothing.
--- @param val number
function PANEL:SetFloatValue(val) end

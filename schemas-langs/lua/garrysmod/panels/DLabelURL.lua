...
function PANEL:GetTextStyleColor() end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Does absolutely nothing at all.
--- @param draw boolean @Does nothing.
function PANEL:SetAutoStretchVertical(draw) end

--- Alias of DLabelURL:SetTextColor.
--- @param col table @The Global.Color to use.
function PANEL:SetColor(col) end
...
--- @param col table @The Global.Color to use.
function PANEL:SetTextColor(col) end
...
function PANEL:SetTextStyleColor(color) end

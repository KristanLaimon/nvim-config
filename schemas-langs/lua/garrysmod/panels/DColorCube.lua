...
function PANEL:OnUserChanged(color) end
...
function PANEL:SetBaseRGB(color) end
...
function PANEL:SetDefaultColor(arg) end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- An Global.AccessorFunc that appears to do nothing and unused.
--- @param hue number
function PANEL:SetHue(hue) end

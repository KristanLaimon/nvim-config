...
function PANEL:AddSheet(name, pnl, icon, noStretchX, noStretchY, tooltip) end
...
function PANEL:CloseTab(tab, removePanel) end
...
function PANEL:SetActiveTab(tab) end
...
function PANEL:SetFadeTime(time) end

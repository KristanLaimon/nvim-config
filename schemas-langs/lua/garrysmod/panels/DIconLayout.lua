...
function PANEL:SetBorder(width) end
...
function PANEL:SetLayoutDir(direction) end
...
function PANEL:SetSpaceX(xSpacing) end
...
function PANEL:SetSpaceY(ySpacing) end
...
function PANEL:SetStretchHeight(do_stretch) end
...
function PANEL:SetStretchWidth(stretchW) end

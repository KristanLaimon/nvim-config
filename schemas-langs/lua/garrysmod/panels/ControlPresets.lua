...
function PANEL:AddConVar(convar) end
...
--- @param data any @data
function PANEL:AddOption(strName, data) end
...
function PANEL:OpenPresetEditor() end

--- @param text string
function PANEL:QuickSaveInternal(text) end

function PANEL:QuickSavePreset() end

function PANEL:ReloadPresets() end

--- Set the name label text.
--- @param name string @The text to put in the label
function PANEL:SetLabel(name) end

--- Uses table.Merge to combine the provided table into the `Options` subtable
--- @param Options table @Options
function PANEL:SetOptions(Options) end

--- @param strName string @Name of preset to set
function PANEL:SetPreset(strName) end

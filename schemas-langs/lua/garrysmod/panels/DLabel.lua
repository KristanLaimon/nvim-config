...
function PANEL:GetDoubleClickingEnabled() end
...
--- @return boolean
function PANEL:GetHighlight() end
...
function PANEL:GetIsToggle() end
...
function PANEL:OnToggled(toggleState) end
...
function PANEL:SetAutoStretchVertical(stretch) end
...
function PANEL:SetDark(dark) end
...
function PANEL:SetDisabled(disable) end

--- Sets whether or not double clicking should call DLabel:DoDoubleClick.
--- This is enabled by default.
--- @param enable boolean @true to enable, false to disable
function PANEL:SetDoubleClickingEnabled(enable) end
...
function PANEL:SetDrawBackground(draw) end

--- Sets the font of the label.
--- @param fontName string @The name of the font
function PANEL:SetFont(fontName) end
...
function PANEL:SetHighlight(highlight) end
...
function PANEL:SetIsMenu(isMenu) end
...
function PANEL:SetToggle(toggleState) end
...
function PANEL:UpdateColours(skin) end

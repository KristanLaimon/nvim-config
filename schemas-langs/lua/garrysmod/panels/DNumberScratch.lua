...
function PANEL:GetDecimals() end
...
function PANEL:GetFloatValue() end
...
function PANEL:GetFraction() end
...
function PANEL:GetTextValue() end

--- Returns the zoom level of the scratch window
--- @return number
function PANEL:GetZoom() end
...
function PANEL:OnValueChanged(newValue) end
...
function PANEL:SetDecimals(decimals) end

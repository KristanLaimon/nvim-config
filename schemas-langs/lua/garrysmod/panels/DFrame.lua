...
function PANEL:GetBackgroundBlur() end
...
function PANEL:GetMinHeight() end
...
function PANEL:GetMinWidth() end
...
function PANEL:GetPaintShadow() end
...
function PANEL:GetScreenLock() end
...
function PANEL:SetBackgroundBlur(blur) end
...
function PANEL:SetDeleteOnClose(shouldDelete) end
...
function PANEL:SetDraggable(draggable) end
...
function PANEL:SetMinHeight(minH) end
...
function PANEL:SetMinWidth(minW) end
...
function PANEL:SetPaintShadow(shouldPaint) end
...
function PANEL:SetScreenLock(lock) end
...
function PANEL:SetSizable(sizeable) end
...
function PANEL:ShowCloseButton(show) end

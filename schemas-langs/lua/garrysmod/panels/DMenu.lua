...
function PANEL:AddCVar(strText, convar, on, off, funcFunction) end
...
function PANEL:AddOption(name, func) end
...
function PANEL:AddPanel(pnl) end

--- Adds a horizontal line spacer.
function PANEL:AddSpacer() end
...
function PANEL:AddSubMenu(Name, func) end
...
function PANEL:ClearHighlights() end
...
--- @return boolean
function PANEL:GetDeleteSelf() end
...
function PANEL:HighlightItem(item) end
...
function PANEL:Open(x, y, skipanimation, ownerpanel) end
...
function PANEL:OpenSubMenu(item, menu) end
...
function PANEL:OptionSelected(option, optionText) end
...
function PANEL:SetDeleteSelf(newState) end
...
function PANEL:SetDrawColumn(draw) end
...
function PANEL:SetMaxHeight(maxHeight) end
...
function PANEL:SetMinimumWidth(minWidth) end

...
function PANEL:AddColumn(column, position) end
...
function PANEL:GetDataHeight() end
...
function PANEL:GetInnerTall() end
...
function PANEL:GetSelectedLine() end
...
function PANEL:GetSortable() end
...
function PANEL:SetMultiSelect(allowMultiSelect) end
...
function PANEL:SetSortable(isSortable) end
...
function PANEL:SortByColumn(columnIndex, descending) end

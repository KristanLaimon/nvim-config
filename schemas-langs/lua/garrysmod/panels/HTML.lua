...
function PANEL:ConsoleMessage(msg, file, lineNr, severity) end
...
function PANEL:OnCallback(library, name, arguments) end

--- Called when this panel's address changes.
--- @param url string @The URL of the new page.
function PANEL:OnChangeAddressBar(url) end

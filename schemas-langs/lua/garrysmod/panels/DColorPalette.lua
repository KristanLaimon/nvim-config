...
function PANEL:DoClick(clr, btn) end
...
function PANEL:GetButtonSize() end
...
function PANEL:OnValueChanged(newcol) end
...
function PANEL:ResetSavedColors() end
...
function PANEL:SaveColor(btn, clr) end
...
function PANEL:SetButtonSize(size) end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Currently does nothing. Intended to "select" the color.
--- @param clr table
function PANEL:SetColor(clr) end
...
function PANEL:SetColorButtons(tab) end
...
function PANEL:SetNumRows(rows) end

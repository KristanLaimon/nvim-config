...
function PANEL:AddChoice(value, data, select, icon) end
...
function PANEL:GetSelectedID() end
...
function PANEL:RemoveChoice(index) end
...
function PANEL:SetSortItems(sort) end

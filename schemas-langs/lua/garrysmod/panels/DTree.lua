...
function PANEL:GetSelectedItem() end
...
function PANEL:GetShowIcons() end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Does nothing.
function PANEL:LayoutTree() end
...
function PANEL:MoveChildTo(child, pos) end
...
function PANEL:SetClickOnDragHover(enable) end
...
function PANEL:SetShowIcons(show) end

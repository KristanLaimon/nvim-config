...
function PANEL:GetImageColor() end
...
function PANEL:GetKeepAspect() end

--- Returns the current Global.Material of the DImage.
--- @return GIMaterial
function PANEL:GetMaterial() end
...
function PANEL:PaintAt(posX, posY, width, height) end
...
function PANEL:SetImageColor(col) end
...
function PANEL:SetOnViewMaterial(mat, backupMat) end

--- Returns true if the image is **not** yet loaded.
--- @return boolean
function PANEL:Unloaded() end

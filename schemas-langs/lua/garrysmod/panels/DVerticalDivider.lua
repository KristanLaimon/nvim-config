...
function PANEL:GetDividerHeight() end
...
function PANEL:GetTopHeight() end
...
function PANEL:SetDividerHeight(height) end
...
function PANEL:SetTopHeight(height) end

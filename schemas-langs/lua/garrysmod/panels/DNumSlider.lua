...
function PANEL:GetDefaultValue() end
...
function PANEL:GetTextArea() end
...
function PANEL:SetConVar(cvar) end
...
function PANEL:SetDefaultValue(default) end
...
function PANEL:SetMinMax(min, max) end

...
function PANEL:GetNotchColor() end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Appears to be non functioning, however is still used by panels such as DNumSlider.
--- @return number
function PANEL:GetNotches() end

--- @deprecated
--- 🛑 **DEPRECATED**:
--- Does nothing.
--- @return any
function PANEL:GetNumSlider() end
...
function PANEL:OnValueChanged(x, y) end
...
--- 🛑 **DEPRECATED**:
--- Does nothing.
function PANEL:SetImageColor() end
...
function PANEL:SetLockX(lockX) end
...
--- </upload>
--- @param trap boolean
function PANEL:SetTrapInside(trap) end

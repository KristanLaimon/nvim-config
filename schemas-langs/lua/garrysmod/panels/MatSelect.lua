...
function PANEL:AddMaterial(label, path) end
...
function PANEL:AddMaterialEx(label, path, value, convars) end
...
function PANEL:FindAndSelectMaterial(mat) end
...
function PANEL:FindMaterialByValue(mat) end
...
function PANEL:GetAutoHeight() end
...
function PANEL:OnRightClick(pnl) end
...
--- @param pnl GPanel @The DImageButton that was clicked.
function PANEL:OnSelect(material, pnl) end
...
function PANEL:SelectedItemPaintOver(w, h) end

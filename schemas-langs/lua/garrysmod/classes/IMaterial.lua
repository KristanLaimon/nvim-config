...
function GIMaterial:GetColor(x, y) end
...
--- @return number @float
function GIMaterial:GetFloat(materialFloat) end
...
function GIMaterial:GetShader() end
...
function GIMaterial:GetString(materialString) end
...
function GIMaterial:GetTexture(param) end
...
function GIMaterial:GetVector(materialVector) end
...
function GIMaterial:GetVector4D(name) end
...
function GIMaterial:IsError() end
...
function GIMaterial:Recompute() end
...
function GIMaterial:SetFloat(materialFloat, float) end
...
function GIMaterial:SetInt(materialInt, int) end
...
function GIMaterial:SetMatrix(materialMatrix, matrix) end
...
function GIMaterial:SetShader(shaderName) end
...
function GIMaterial:SetString(materialString, string) end
...
function GIMaterial:SetTexture(materialTexture, texture) end
...
function GIMaterial:SetUndefined(materialValueName) end
...
function GIMaterial:SetVector(MaterialVector, vec) end

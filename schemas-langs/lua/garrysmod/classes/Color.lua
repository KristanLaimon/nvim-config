...
function GColor:AddBlackness(blackness) end
...
function GColor:AddBrightness(saturation) end
...
function GColor:AddHue(hue) end
...
function GColor:AddLightness(lightness) end
...
function GColor:AddSaturation(saturation) end
...
function GColor:AddWhiteness(whiteness) end
...
function GColor:GetBlackness() end
...
function GColor:GetBrightness() end
...
function GColor:GetLightness() end
...
function GColor:GetSaturation() end
...
function GColor:GetWhiteness() end
...
function GColor:Lerp(target, fraction) end
...
function GColor:SetBlackness(blackness) end
...
function GColor:SetBrightness(saturation) end
...
function GColor:SetHue(hue) end
...
function GColor:SetLightness(lightness) end
...
function GColor:SetSaturation(saturation) end
...
function GColor:SetUnpacked(r, g, b, a) end
...
function GColor:SetWhiteness(whiteness) end

...
function GWorkshopFileBase:Fetch(type, offset, perpage, extratags, searchText, filter, sort) end
...
--- @param filter? number @The filter for the results
--- @param sort? string @How it should be sorted
function GWorkshopFileBase:FetchSubscribed(offset, perpage, tags, searchText, isUGC, filter, sort) end
...
function GWorkshopFileBase:FillFileInfo(results, isUGC) end
...
function GWorkshopFileBase:Publish(filename, image) end

--- Retrieves the username for the given SteamID.
--- @param steamid string @SteamID to retrieve the name for
--- @param callback function @Callback function
function GWorkshopFileBase:RetrieveUserName(steamid, callback) end

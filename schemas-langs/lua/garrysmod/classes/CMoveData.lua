...
function GCMoveData:GetConstraintCenter() end
...
function GCMoveData:GetConstraintRadius() end
...
function GCMoveData:GetConstraintSpeedScale() end
...
function GCMoveData:KeyPressed(key) end
...
function GCMoveData:KeyReleased(key) end
...
function GCMoveData:SetConstraintCenter(pos) end
...
function GCMoveData:SetConstraintRadius(radius) end
...
function GCMoveData:SetConstraintSpeedScale(arg) end
...
function GCMoveData:SetMaxClientSpeed(maxSpeed) end
...
--- @param maxSpeed number @The new maximum speed
function GCMoveData:SetMaxSpeed(maxSpeed) end

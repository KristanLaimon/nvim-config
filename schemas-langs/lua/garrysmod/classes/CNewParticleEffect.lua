...
function GCNewParticleEffect:AddControlPoint(cpID, ent, partAttachment, entAttachment, offset) end

--- @return boolean
function GCNewParticleEffect:GetAutoUpdateBBox() end

--- Returns the name of the particle effect this system is set to emit.
--- @return string @The name of the particle effect.
function GCNewParticleEffect:GetEffectName() end
...
function GCNewParticleEffect:GetHighestControlPoint() end
...
function GCNewParticleEffect:GetOwner() end
...
function GCNewParticleEffect:GetRenderBounds() end
...
function GCNewParticleEffect:SetControlPointOrientation(cpID, forward, right, up) end
...
function GCNewParticleEffect:SetControlPointParent(childID, parentID) end

--- Sets the right direction for given control point.
--- @param cpID number @The control point ID, 0 to 63.
--- @param right GVector @The right direction for given control point.
function GCNewParticleEffect:SetControlPointRightVector(cpID, right) end

--- Sets the upward direction for given control point.
--- @param cpID number @The control point ID, 0 to 63.
--- @param upward GVector @The upward direction for given control point
function GCNewParticleEffect:SetControlPointUpVector(cpID, upward) end
...
function GCNewParticleEffect:SetIsViewModelEffect(isViewModel) end
...
function GCNewParticleEffect:SetShouldDraw(should) end
...
function GCNewParticleEffect:SetSortOrigin(origin) end

--- Starts the particle emission.
--- @param infiniteOnly? boolean
function GCNewParticleEffect:StartEmission(infiniteOnly) end

--- Stops the particle emission.
--- @param infiniteOnly? boolean
--- @param removeAllParticles? boolean
--- @param wakeOnStop? boolean
function GCNewParticleEffect:StopEmission(infiniteOnly, removeAllParticles, wakeOnStop) end
...
function GCNewParticleEffect:StopEmissionAndDestroyImmediately() end

...
function GCTakeDamageInfo:AddDamage(damageIncrease) end

--- Returns the ammo type used by the weapon that inflicted the damage.
--- @return number @Ammo type ID
function GCTakeDamageInfo:GetAmmoType() end
...
function GCTakeDamageInfo:GetAttacker() end

--- Returns the initial unmodified by skill level ( game.GetSkillLevel ) damage.
--- @return number @baseDamage
function GCTakeDamageInfo:GetBaseDamage() end

--- Returns the total damage.
--- @return number @damage
function GCTakeDamageInfo:GetDamage() end

--- Gets the current bonus damage.
--- @return number @Bonus damage
function GCTakeDamageInfo:GetDamageBonus() end
...
function GCTakeDamageInfo:GetDamageCustom() end
...
function GCTakeDamageInfo:GetDamageForce() end
...
function GCTakeDamageInfo:GetDamagePosition() end
...
function GCTakeDamageInfo:GetDamageType() end
...
function GCTakeDamageInfo:GetWeapon() end

--- Returns true if the damage was caused by a bullet.
--- @return boolean @isBulletDmg
function GCTakeDamageInfo:IsBulletDamage() end
...
function GCTakeDamageInfo:SetAttacker(ent) end
...
function GCTakeDamageInfo:SetBaseDamage(arg) end

--- Sets the amount of damage.
--- @param damage number @The value to set the absolute damage to.
function GCTakeDamageInfo:SetDamage(damage) end
...
function GCTakeDamageInfo:SetDamageBonus(damage) end
...
function GCTakeDamageInfo:SetDamageCustom(DamageType) end
...
function GCTakeDamageInfo:SetWeapon(arg) end

--- Subtracts the specified amount from the damage.
--- @param damage number @Value to subtract.
function GCTakeDamageInfo:SubtractDamage(damage) end

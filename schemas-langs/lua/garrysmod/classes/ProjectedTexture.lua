...
function GProjectedTexture:GetAngles() end
...
function GProjectedTexture:GetBrightness() end
...
function GProjectedTexture:GetColor() end
...
function GProjectedTexture:GetConstantAttenuation() end
...
function GProjectedTexture:GetEnableShadows() end
...
function GProjectedTexture:GetFarZ() end
...
function GProjectedTexture:GetHorizontalFOV() end
...
function GProjectedTexture:GetLightWorld() end
...
function GProjectedTexture:GetLinearAttenuation() end
...
function GProjectedTexture:GetNearZ() end
...
function GProjectedTexture:GetNoCull() end
...
function GProjectedTexture:GetOrthographic() end
...
function GProjectedTexture:GetPos() end
...
function GProjectedTexture:GetQuadraticAttenuation() end
...
function GProjectedTexture:GetShadowDepthBias() end
...
function GProjectedTexture:GetShadowFilter() end
...
function GProjectedTexture:GetShadowSlopeScaleDepthBias() end

--- Returns the target entity of this projected texture.
--- @return GEntity @The current target entity.
function GProjectedTexture:GetTargetEntity() end
...
function GProjectedTexture:GetTexture() end
...
function GProjectedTexture:GetTextureFrame() end
...
function GProjectedTexture:GetVerticalFOV() end
...
function GProjectedTexture:IsValid() end
...
function GProjectedTexture:Remove() end
...
function GProjectedTexture:SetConstantAttenuation(constAtten) end
...
function GProjectedTexture:SetEnableShadows(newState) end

--- Sets the angle of projection.
--- You must call ProjectedTexture:Update after using this function for it to take effect.
--- @param fov number @Must be higher than 0 and lower than 180
function GProjectedTexture:SetFOV(fov) end

--- Sets the distance at which the projected texture ends.
--- You must call ProjectedTexture:Update after using this function for it to take effect.
--- @param farZ number
function GProjectedTexture:SetFarZ(farZ) end
...
function GProjectedTexture:SetHorizontalFOV(hFOV) end
...
function GProjectedTexture:SetLightWorld(lightworld) end
...
function GProjectedTexture:SetLinearAttenuation(linearAtten) end
...
--- @param nearZ number
function GProjectedTexture:SetNearZ(nearZ) end
...
function GProjectedTexture:SetNoCull(enable) end
...
function GProjectedTexture:SetOrthographic(orthographic, left, top, right, bottom) end

--- Move the Projected Texture to the specified position.
--- You must call ProjectedTexture:Update after using this function for it to take effect.
--- @param position GVector
function GProjectedTexture:SetPos(position) end
...
function GProjectedTexture:SetQuadraticAttenuation(quadAtten) end
...
function GProjectedTexture:SetShadowDepthBias(bias) end
...
function GProjectedTexture:SetShadowFilter(filter) end
...
function GProjectedTexture:SetShadowSlopeScaleDepthBias(bias) end
...
function GProjectedTexture:SetTargetEntity(target) end

--- Sets the texture to be projected.
--- You must call ProjectedTexture:Update after using this function for it to take effect.
--- @param texture string @The name of the texture
function GProjectedTexture:SetTexture(texture) end
...
function GProjectedTexture:SetTextureFrame(frame) end
...
function GProjectedTexture:SetVerticalFOV(vFOV) end
...
function GProjectedTexture:Update() end

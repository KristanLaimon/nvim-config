...
function GVector:AngleEx(up) end
...
function GVector:Cross(otherVector) end
...
function GVector:DistToSqr(otherVec) end
...
function GVector:Distance(otherVector) end
...
function GVector:Distance2D(otherVector) end
...
function GVector:Distance2DSqr(otherVec) end
...
function GVector:Div(divisor) end
...
function GVector:Dot(otherVector) end
...
function GVector:DotProduct(Vector) end
...
function GVector:GetNegated() end
...
function GVector:GetNormal() end
...
--- @return GVector @Normalized version of the vector.
function GVector:GetNormalized() end
...
function GVector:Length2DSqr() end
...
function GVector:LengthSqr() end
...
function GVector:Normalize() end
...
function GVector:Random(min, max) end
...
function GVector:WithinAABox(boxStart, boxEnd) end

--- Sets x, y and z to 0.
function GVector:Zero() end

...
function GIVideoWriter:AddFrame(frameTime, downsample) end

--- Ends the video recording and dumps it to disk.
function GIVideoWriter:Finish() end

--- Returns the height of the video stream.
--- @return number @height
function GIVideoWriter:Height() end

--- Sets whether to record sound or not.
--- @param record boolean @Record.
function GIVideoWriter:SetRecordSound(record) end

--- Returns the width of the video stream.
--- @return number @width
function GIVideoWriter:Width() end

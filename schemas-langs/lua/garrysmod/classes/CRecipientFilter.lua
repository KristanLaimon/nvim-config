...
function GCRecipientFilter:AddAllPlayers() end
...
function GCRecipientFilter:AddPAS(pos) end
...
function GCRecipientFilter:GetPlayers() end

--- Removes all players from the recipient filter.
function GCRecipientFilter:RemoveAllPlayers() end
...
function GCRecipientFilter:RemoveMismatchedPlayers(input) end
...
function GCRecipientFilter:RemovePAS(position) end
...
function GCRecipientFilter:RemovePVS(pos) end
...
function GCRecipientFilter:RemovePlayer(Player) end

...
function GIGModAudioChannel:EnableLooping(enable) end
...
function GIGModAudioChannel:FFT(tbl, size) end
...
function GIGModAudioChannel:Get3DCone() end
...
function GIGModAudioChannel:GetBitsPerSample() end
...
function GIGModAudioChannel:GetTagsHTTP() end
...
function GIGModAudioChannel:GetTagsID3() end
...
function GIGModAudioChannel:GetTagsMP4() end
...
function GIGModAudioChannel:Set3DCone(innerAngle, outerAngle, outerVolume) end
...
function GIGModAudioChannel:SetPan(pan) end
...
function GIGModAudioChannel:SetPlaybackRate(rate) end
...
function GIGModAudioChannel:SetPos(pos, dir) end
...
function GIGModAudioChannel:SetTime(secs, dont_decode) end

--- Sets the volume of a sound channel
--- @param volume number @Volume to set
function GIGModAudioChannel:SetVolume(volume) end
...
function GIGModAudioChannel:Stop() end

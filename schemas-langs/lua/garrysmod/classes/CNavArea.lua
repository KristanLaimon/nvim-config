...
function GCNavArea:AddAttributes(attribs) end
...
function GCNavArea:AddHidingSpot(pos, flags) end
...
function GCNavArea:AddToClosedList() end

--- Adds this CNavArea to the Open List.
--- Used in pathfinding via the [A* algorithm](https://en.wikipedia.org/wiki/A*_search_algorithm).
--- More information can be found on the Simple Pathfinding page.
function GCNavArea:AddToOpenList() end

--- Clears the open and closed lists for a new search.
--- Used in pathfinding via the [A* algorithm](https://en.wikipedia.org/wiki/A*_search_algorithm).
--- More information can be found on the Simple Pathfinding page.
function GCNavArea:ClearSearchLists() end
...
function GCNavArea:ComputeAdjacentConnectionHeightChange(navarea) end
...
function GCNavArea:ComputeDirection(pos) end
...
function GCNavArea:ComputeGroundHeightChange(navArea) end
...
function GCNavArea:ConnectTo(area) end
...
function GCNavArea:Contains(pos) end
...
function GCNavArea:GetAdjacentAreaDistances(dir) end
...
function GCNavArea:GetAdjacentAreas() end
...
function GCNavArea:GetAdjacentAreasAtSide(navDir) end
...
function GCNavArea:GetAdjacentCount() end
...
function GCNavArea:GetAdjacentCountAtSide(navDir) end
...
function GCNavArea:GetClosestPointOnArea(pos) end
...
--- @return table @A table of Vectors
function GCNavArea:GetHidingSpots(type) end

--- Returns this CNavAreas unique ID.
--- @return number @The unique ID.
function GCNavArea:GetID() end
...
--- @param dir? number @If set, will only return areas in the specified direction
--- @return table @A list of tables in the following format:
function GCNavArea:GetIncomingConnectionDistances(dir) end
...
function GCNavArea:GetIncomingConnections() end
...
function GCNavArea:GetIncomingConnectionsAtSide(navDir) end
...
function GCNavArea:GetLadders() end
...
function GCNavArea:GetRandomAdjacentAreaAtSide(navDir) end

--- Returns a random point on the nav area.
--- @return GVector @The random point on the nav area.
function GCNavArea:GetRandomPoint() end

--- Returns the width this Nav Area.
--- @return number
function GCNavArea:GetSizeX() end

--- Returns the height of this Nav Area.
--- @return number
function GCNavArea:GetSizeY() end
...
function GCNavArea:GetSpotEncounters() end
...
function GCNavArea:GetTotalCost() end
...
function GCNavArea:GetVisibleAreas() end
...
function GCNavArea:GetZ(pos) end
...
function GCNavArea:HasAttributes(attribs) end
...
function GCNavArea:IsCompletelyVisible(area) end
...
function GCNavArea:IsConnected(navArea) end
...
function GCNavArea:IsConnectedAtSide(navArea, navDirType) end
...
function GCNavArea:IsCoplanar(navArea) end
...
function GCNavArea:IsDamaging() end
...
function GCNavArea:IsOverlapping(pos, tolerance) end
...
function GCNavArea:IsOverlappingArea(navArea) end
...
function GCNavArea:IsVisible(pos) end
...
function GCNavArea:MarkAsBlocked(teamID) end
...
function GCNavArea:MarkAsDamaging(duration) end
...
function GCNavArea:MarkAsUnblocked(teamID) end
...
function GCNavArea:PlaceOnGround(corner) end
...
function GCNavArea:PopOpenList() end

--- Removes the given nav area.
function GCNavArea:Remove() end
...
function GCNavArea:RemoveAttributes(attribs) end
...
function GCNavArea:SetParent(parent, how) end
...
function GCNavArea:SetPlace(place) end
...
function GCNavArea:SetTotalCost(cost) end
...
--- Used in pathfinding via the [A* algorithm](https://en.wikipedia.org/wiki/A*_search_algorithm).
--- More information can be found on the Simple Pathfinding page.
function GCNavArea:UpdateOnOpenList() end

...
function GPathFollower:Chase(bot, ent, generator) end
...
function GPathFollower:GetClosestPosition(position) end
...
function GPathFollower:GetPositionOnPath(distance) end

--- Returns the path start position
--- @return GVector @The start position
function GPathFollower:GetStart() end

--- Invalidates the current path
function GPathFollower:Invalidate() end

--- Returns true if the path is valid
--- @return boolean @Wether the path is valid or not.
function GPathFollower:IsValid() end

--- Returns the last segment of the path.
--- @return table @A table with Structures/PathSegment.
function GPathFollower:LastSegment() end
...
function GPathFollower:MoveCursor(distance) end
...
function GPathFollower:MoveCursorTo(distance) end

...
function GCLuaEmitter:Add(material, position) end

--- Manually renders all particles the emitter has created.
function GCLuaEmitter:Draw() end
...
function GCLuaEmitter:GetPos() end
...
function GCLuaEmitter:SetBBox(mins, maxs) end
...
function GCLuaEmitter:SetNearClip(distanceMin, distanceMax) end
...
function GCLuaEmitter:SetNoDraw(noDraw) end
...
function GCLuaEmitter:SetParticleCullRadius(radius) end

--- Sets the position of the particle emitter.
--- @param position GVector @New position.
function GCLuaEmitter:SetPos(position) end

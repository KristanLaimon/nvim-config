...
function GTool:BuildConVarList() end

--- Clears all objects previously set with Tool:SetObject.
function GTool:ClearObjects() end
...
function GTool:GetHelpText() end
...
function GTool:GetStage() end

--- Returns the Tool Gun (`gmod_tool`) Scripted Weapon.
--- @return GWeapon @The tool gun weapon
function GTool:GetWeapon() end
...
function GTool:MakeGhostEntity(model, pos, angle) end
...
function GTool:RebuildControlPanel(...) end
...
function GTool:ReleaseGhostEntity() end
...
function GTool:SetObject(id, ent, pos, phys, bone, normal) end
...
function GTool:SetOperation(operation) end
...
function GTool:UpdateGhostEntity() end

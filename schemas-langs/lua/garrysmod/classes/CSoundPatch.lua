...
function GCSoundPatch:ChangePitch(pitch, deltaTime) end
...
function GCSoundPatch:ChangeVolume(volume, deltaTime) end
...
function GCSoundPatch:FadeOut(seconds) end
...
function GCSoundPatch:SetDSP(dspEffectId) end

--- Sets the sound level in decibel.
--- @param level number @The sound level in decibel
function GCSoundPatch:SetSoundLevel(level) end
...
function GCSoundPatch:Stop() end

...
function GCLuaParticle:GetRoll() end
...
function GCLuaParticle:GetRollDelta() end
...
function GCLuaParticle:GetStartAlpha() end
...
function GCLuaParticle:SetCollide(shouldCollide) end
...
function GCLuaParticle:SetEndAlpha(endAlpha) end
...
function GCLuaParticle:SetEndLength(endLength) end
...
function GCLuaParticle:SetLifeTime(lifeTime) end
...
function GCLuaParticle:SetLighting(useLighting) end

--- Sets the material of the particle.
--- @param mat GIMaterial @The new material to set
function GCLuaParticle:SetMaterial(mat) end
...
function GCLuaParticle:SetNextThink(nextThink) end

--- Sets the absolute position of the particle.
--- @param pos GVector @The new particle position.
function GCLuaParticle:SetPos(pos) end
...
function GCLuaParticle:SetRoll(roll) end

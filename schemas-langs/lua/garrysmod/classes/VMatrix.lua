...
--- @param input GVMatrix @The input matrix to add.
function GVMatrix:Add(input) end
...
function GVMatrix:GetAngles() end
...
function GVMatrix:GetField(row, column) end
...
function GVMatrix:GetForward() end
...
function GVMatrix:GetInverse() end
...
function GVMatrix:GetInverseTR() end
...
function GVMatrix:GetUp() end

--- Initializes the matrix as Identity matrix.
function GVMatrix:Identity() end
...
function GVMatrix:IsRotationMatrix() end
...
--- @param e43 number
--- @param e44 number
function GVMatrix:SetUnpacked(e11, e12, e13, e14, e21, e22, e23, e24, e31, e32, e33, e34, e41, e42, e43, e44) end

--- Sets the up direction of the matrix.
--- ie. The third column of the matrix, excluding the w coordinate.
--- @param forward GVector @The up direction of the matrix.
function GVMatrix:SetUp(forward) end

--- Subtracts given matrix from this matrix.
--- @param input GVMatrix @The input matrix to subtract.
function GVMatrix:Sub(input) end

--- Converts the matrix to a 4x4 table. See Global.Matrix function.
--- @return table @The 4x4 table.
function GVMatrix:ToTable() end
...
function GVMatrix:Translate(translation) end

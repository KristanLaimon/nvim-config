...
function GWeapon:AllowsAutoSwitchFrom() end
...
function GWeapon:AllowsAutoSwitchTo() end
...
function GWeapon:CallOnClient(functionName, data) end
...
function GWeapon:DefaultReload(act) end
...
function GWeapon:GetActivity() end
...
function GWeapon:GetWeight() end
...
function GWeapon:IsCarriedByLocalPlayer() end
...
function GWeapon:IsScripted() end
...
function GWeapon:IsWeaponVisible() end
...
function GWeapon:SetDeploySpeed(speed) end
...
function GWeapon:SetHoldType(name) end
...
function GWeapon:SetLastShootTime(time) end
...
function GWeapon:SetNextPrimaryFire(time) end
...
function GWeapon:SetNextSecondaryFire(time) end

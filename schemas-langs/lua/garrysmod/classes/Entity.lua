...
function GEntity:AddCallback(hook, func) end

--- Adds engine flags.
--- @param flag EEFL @Engine flag to add, see Enums/EFL
function GEntity:AddEFlags(flag) end
...
function GEntity:AddEffects(effect) end

--- Adds flags to the entity.
--- @param flag EFL @Flag to add, see Enums/FL
function GEntity:AddFlags(flag) end
...
function GEntity:AddGesture(activity, autokill) end
...
--- @param autokill? boolean @Automatically remove the gesture when it fully plays (Entity:GetLayerCycle reaches 1).
--- @return number @Layer ID of the started gesture, used to manipulate the played gesture by other functions.
function GEntity:AddGestureSequence(sequence, autokill) end
...
function GEntity:AddLayeredSequence(sequence, priority) end

--- Adds solid flag(s) to the entity.
--- @param flags number @The flag(s) to apply, see Enums/FSOLID.
function GEntity:AddSolidFlags(flags) end
...
function GEntity:AddSpawnFlags(flag) end
...
function GEntity:AddToMotionController(physObj) end
...
function GEntity:AlignAngles(from, to) end
...
function GEntity:BecomeRagdollOnClient() end
...
function GEntity:BeingLookedAtByLocalPlayer() end
...
function GEntity:BodyTarget(origin, noisy) end
...
function GEntity:BoneHasFlag(boneID, flag) end
...
function GEntity:BoneLength(boneID) end
...
function GEntity:BoundingRadius() end
...
function GEntity:CallDTVarProxies(type, slot, newValue) end
...
function GEntity:CallOnRemove(identifier, removeFunc, ...) end
...
function GEntity:ClearAllOutputs(outputName) end

--- Resets all pose parameters such as aim_yaw, aim_pitch and rotation.
function GEntity:ClearPoseParameters() end
...
function GEntity:CollisionRulesChanged() end
...
function GEntity:CreateBoneFollowers(bone_whitelist) end
...
function GEntity:DestroyShadow() end
...
function GEntity:DisableMatrix(matrixType) end
...
function GEntity:DispatchTraceAttack(damageInfo, traceRes, dir) end
...
function GEntity:Dissolve(type, magnitude, origin) end
...
function GEntity:DontDeleteOnRemove(entityToUnremove) end
...
function GEntity:DropToFloor(mask, ignoreEnt, maxDist) end
...
function GEntity:EmitSound(soundName, soundLevel, pitchPercent, volume, channel, soundFlags, dsp, filter) end
...
function GEntity:EnableConstraints(toggleConstraints) end
...
function GEntity:EnableCustomCollisions() end
...
function GEntity:EnableMatrix(matrixType, matrix) end
...
function GEntity:Extinguish() end
...
function GEntity:FindBodygroupByName(name) end
...
function GEntity:FindGestureLayer(activity) end
...
--- @return number @A layer ID for given activity, or `-1` if not found.
function GEntity:FindGestureLayer(sequenceID) end
...
function GEntity:FindTransitionSequence(currentSequence, goalSequence) end
...
function GEntity:Fire(input, param, delay, activator, caller) end
...
function GEntity:FireBullets(bulletInfo, suppressHostEvents) end
...
function GEntity:FollowBone(parent, boneid) end
...
function GEntity:ForcePlayerDrop() end
...
function GEntity:FrameAdvance() end
...
function GEntity:GetAbsVelocity() end
...
function GEntity:GetAngles() end
...
function GEntity:GetAnimCount() end
...
function GEntity:GetAnimInfo(animIndex) end
...
function GEntity:GetAnimTime() end
...
function GEntity:GetAnimTimeInterval() end
...
function GEntity:GetAttachment(attachmentId) end
...
function GEntity:GetAttachments() end
...
function GEntity:GetBaseVelocity() end
...
function GEntity:GetBloodColor() end
...
function GEntity:GetBodyGroups() end
...
function GEntity:GetBodygroup(bodyGroupId) end
...
function GEntity:GetBodygroupCount(bodyGroupId) end
...
function GEntity:GetBodygroupName(bodyGroupId) end
...
function GEntity:GetBoneContents(bone) end
...
function GEntity:GetBoneController(boneID) end
...
function GEntity:GetBoneCount() end
...
function GEntity:GetBoneMatrix(boneID) end
...
function GEntity:GetBoneName(index) end
...
function GEntity:GetBoneParent(bone) end
...
function GEntity:GetBonePosition(boneIndex) end
...
function GEntity:GetBoneSurfaceProp(bone) end
...
function GEntity:GetBrushPlane(id) end
...
function GEntity:GetBrushPlaneCount() end
...
function GEntity:GetBrushSurfaces() end
...
function GEntity:GetCallbacks(hook) end
...
function GEntity:GetChildBones(boneid) end
...
function GEntity:GetChildren() end
...
function GEntity:GetConstrainedPhysObjects() end
...
function GEntity:GetCustomCollisionCheck() end
...
function GEntity:GetFlexBounds(flex) end
...
function GEntity:GetFlexIDByName(name) end
...
function GEntity:GetFlexName(id) end
...
function GEntity:GetFlexNum() end

--- Returns the flex scale of the entity.
--- @return number @The flex scale
function GEntity:GetFlexScale() end
...
function GEntity:GetFlexType(id) end
...
function GEntity:GetGroundSpeedVelocity() end
...
function GEntity:GetHitBoxBone(hitbox, hboxset) end
...
function GEntity:GetHitBoxBounds(hitbox, set) end
...
function GEntity:GetHitBoxCount(set) end
...
function GEntity:GetHitBoxGroupCount() end
...
function GEntity:GetHitBoxHitGroup(hitbox, hitboxset) end
...
function GEntity:GetInternalVariable(variableName) end
...
function GEntity:GetKeyValues() end
...
function GEntity:GetLocalPos() end
...
function GEntity:GetManipulateBoneAngles(boneID) end
...
function GEntity:GetManipulateBoneJiggle(boneID) end
...
function GEntity:GetManipulateBonePosition(boneId) end
...
function GEntity:GetManipulateBoneScale(boneID) end
...
function GEntity:GetMaterial() end
...
function GEntity:GetMaterialType() end
...
function GEntity:GetModelPhysBoneCount() end

--- Gets the models radius.
--- @return number @The radius of the model
function GEntity:GetModelRadius() end
...
function GEntity:GetMomentaryRotButtonPos(turnAngle) end
...
function GEntity:GetMoveCollide() end
...
function GEntity:GetMoveParent() end

--- Returns the entity's movetype
--- @return number @Move type
function GEntity:GetMoveType() end
...
function GEntity:GetNPCClass() end
...
function GEntity:GetNW2VarProxy(key) end
...
function GEntity:GetName() end

--- Gets networked angles for entity.
--- @return GAngle @angle
function GEntity:GetNetworkAngles() end
...
function GEntity:GetNetworkOrigin() end
...
function GEntity:GetNetworkVars() end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworked2Angle(key, fallback) end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworked2Bool(key, fallback) end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworked2Entity(key, fallback) end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworked2Float(key, fallback) end
...
--- @param fallback? any @The value to return if we failed to retrieve the value (If it isn't set).
--- @return any @The value associated with the key
function GEntity:GetNetworked2Int(key, fallback) end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworked2String(key, fallback) end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworked2Var(key, fallback) end
...
--- @param key any @The key of the NWVar to get callback of.
--- @return function @The callback of given NWVar, or nil if not found.
function GEntity:GetNetworked2VarProxy(key) end
...
function GEntity:GetNetworked2VarTable() end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworked2Vector(key, fallback) end
...
function GEntity:GetNetworkedAngle(key, fallback) end
...
function GEntity:GetNetworkedBool(key, fallback) end
...
function GEntity:GetNetworkedEntity(key, fallback) end
...
function GEntity:GetNetworkedFloat(key, fallback) end
...
--- @param fallback? number @The value to return if we failed to retrieve the value
--- @return number @The retrieved value
function GEntity:GetNetworkedInt(key, fallback) end
...
function GEntity:GetNetworkedString(key, fallback) end
...
--- @param fallback? any @The value to return if we failed to retrieve the value
--- @return any @The value associated with the key
function GEntity:GetNetworkedVar(key, fallback) end
...
function GEntity:GetNetworkedVarProxy(name) end

--- @deprecated
--- 🛑 **DEPRECATED**: You should be using Entity:GetNWVarTable instead.
--- Returns all the networked variables in an entity.
--- @return {[string]: any} @Key-Value table of all networked variables.
function GEntity:GetNetworkedVarTable() end
...
function GEntity:GetNetworkedVector(key, fallback) end
...
function GEntity:GetNoDraw() end
...
function GEntity:GetOwner() end

--- Returns the parent entity of this entity.
--- @return GEntity @parentEntity
function GEntity:GetParent() end
...
function GEntity:GetParentAttachment() end
...
function GEntity:GetParentPhysNum() end
...
function GEntity:GetParentWorldTransformMatrix() end
...
function GEntity:GetPersistent() end
...
function GEntity:GetPhysicsAttacker(timeLimit) end
...
function GEntity:GetPredictable() end
...
function GEntity:GetPreferredCarryAngles(ply) end
...
function GEntity:GetRagdollOwner() end
...
function GEntity:GetRenderAngles() end
...
function GEntity:GetRotatedAABB(min, max) end
...
function GEntity:GetSaveTable(showAll) end
...
function GEntity:GetSequence() end
...
function GEntity:GetSequenceActivity(seq) end
...
function GEntity:GetSequenceActivityName(sequenceId) end
...
function GEntity:GetSequenceMoveDist(sequenceId) end
...
function GEntity:GetSequenceMoveYaw(seq) end
...
function GEntity:GetSequenceMovement(sequenceId, startCycle, endCyclnde) end
...
function GEntity:GetSequenceName(index) end
...
function GEntity:GetSequenceVelocity(sequenceId, cycle) end
...
function GEntity:GetShouldPlayPickupSound() end
...
function GEntity:GetSpawnEffect() end
...
function GEntity:GetSpawnFlags() end
...
function GEntity:GetSubMaterial(index) end
...
function GEntity:GetSubModels() end
...
function GEntity:GetSurroundingBounds() end
...
function GEntity:GetVar(key, default) end
...
--- @return GVector @The velocity of the entity.
function GEntity:GetVelocity() end
...
function GEntity:GetWorkshopID() end
...
--- @return GVMatrix @The position and angle matrix.
function GEntity:GetWorldTransformMatrix() end
...
function GEntity:GibBreakClient(force, clr) end
...
--- @param force GVector @The force to apply to the created gibs
function GEntity:GibBreakServer(force) end
...
function GEntity:HasBoneManipulations() end
...
function GEntity:HasFlexManipulatior() end
...
function GEntity:HasSpawnFlags(spawnFlags) end
...
function GEntity:HeadTarget(origin) end

--- Returns the health of the entity.
--- @return number @health
function GEntity:Health() end
...
function GEntity:Ignite(length, radius) end
...
function GEntity:InitializeAsClientEntity() end
...
function GEntity:Input(input, activator, caller, param) end
...
function GEntity:InvalidateBoneCache() end
...
function GEntity:IsConstrained() end
...
function GEntity:IsConstraint() end
...
function GEntity:IsLineOfSightClear(target) end
...
function GEntity:IsMarkedForDeletion() end
...
function GEntity:IsPlayerHolding() end
...
function GEntity:IsPlayingGesture(activity) end
...
function GEntity:IsPointInBounds(point) end
...
function GEntity:IsRagdoll() end
...
function GEntity:IsScripted() end
...
function GEntity:IsSequenceFinished() end
...
function GEntity:LocalToWorld(lpos) end
...
function GEntity:LocalToWorldAngles(ang) end
...
function GEntity:LookupAttachment(attachmentName) end
...
function GEntity:LookupBone(boneName) end
...
function GEntity:LookupPoseParameter(name) end
...
function GEntity:LookupSequence(name) end
...
function GEntity:MakePhysicsObjectAShadow(allowPhysicsMovement, allowPhysicsRotation) end
...
function GEntity:ManipulateBoneScale(boneID, scale) end
...
function GEntity:MapCreationID() end

--- Refreshes the shadow of the entity.
function GEntity:MarkShadowAsDirty() end
...
function GEntity:MuzzleFlash() end
...
function GEntity:NearestPoint(position) end
...
function GEntity:NetworkVar(type, slot, name, extended) end
--- Creates a network variable on the entity and adds Set/Get functions for it. This function should only be called in ENTITY:SetupDataTables.
--- See Entity:NetworkVarNotify for a function to hook NetworkVar changes.
--- ℹ **NOTE**: Entity NetworkVars are influenced by the return value of ENTITY:UpdateTransmitState.
--- So if you use the **PVS**(**default**), then the NetworkVars can be different for each client.
...
--- @param name string @The name will affect how you access it
--- @param extended? table @A table of extended information
function GEntity:NetworkVar(type, name, extended) end
...
function GEntity:NetworkVarElement(type, slot, element, name, extended) end
--- Similarly to Entity:NetworkVar, creates a network variable on the entity and adds Set/Get functions for it. This method stores it's value as a member value of a vector or an angle. This allows to go beyond the normal variable limit of Entity:NetworkVar for `Int` and `Float` types, at the expense of `Vector` and `Angle` limit.
--- This function should only be called in ENTITY:SetupDataTables.
--- ⚠ **WARNING**: Make sure to not call the SetDT* and your custom set methods on the client realm unless you know exactly what you are doing.
--- @param type string @Supported choices:
...
--- @param name string @The name will affect how you access it
--- @param extended? table @A table of extra information
function GEntity:NetworkVarElement(type, element, name, extended) end
...
function GEntity:NetworkVarNotify(name, callback) end
...
function GEntity:NextThink(timestamp) end
...
function GEntity:OBBCenter() end
...
function GEntity:ObjectCaps() end
...
function GEntity:PassesDamageFilter(dmg) end
...
function GEntity:PhysicsFromMesh(vertices, surfaceprop, massCenterOveride) end
...
function GEntity:PhysicsInit(solidType, massCenterOverride) end
...
--- @param massCenterOverride? GVector @If set, overwrites the center of mass for the created physics object.
--- @return boolean @Returns `true` on success, `nil` otherwise
function GEntity:PhysicsInitBox(mins, maxs, surfaceprop, massCenterOverride) end
...
--- @param massCenterOverride? GVector @If set, overwrites the center of mass for the created physics object.
--- @return boolean @Returns `true` on success, `false` otherwise.
function GEntity:PhysicsInitConvex(points, surfaceprop, massCenterOverride) end
...
--- @param massCenterOverride? GVector @If set, overwrites the center of mass for the created physics object.
--- @return boolean @Returns `true` on success, `nil` otherwise.
function GEntity:PhysicsInitMultiConvex(vertices, surfaceprop, massCenterOverride) end
...
function GEntity:PhysicsInitShadow(allowPhysicsMovement, allowPhysicsRotation) end
...
--- @return boolean @Returns `true` on success, `false` otherwise
function GEntity:PhysicsInitSphere(radius, physmat) end
...
--- @param solidType number @The solid type of the physics object to create, see Enums/SOLID
--- @return boolean @Returns `true` on success, `false` otherwise
function GEntity:PhysicsInitStatic(solidType) end
...
function GEntity:PrecacheGibs() end
...
function GEntity:RagdollSolve() end
...
function GEntity:RagdollStopControlling() end
...
function GEntity:RagdollUpdatePhysics() end
...
function GEntity:Remove() end

--- Removes all decals from the entities surface.
function GEntity:RemoveAllDecals() end
...
function GEntity:RemoveAllGestures() end
...
function GEntity:RemoveCallOnRemove(identifier) end
...
function GEntity:RemoveFromMotionController(physObj) end
...
function GEntity:RemoveGesture(activity) end
...
function GEntity:RemoveSpawnFlags(flag) end
...
function GEntity:RestartGesture(activity, addIfMissing, autokill) end
...
function GEntity:SelectWeightedSequence(act) end
...
--- @return number @The sequence ID
function GEntity:SelectWeightedSequenceSeeded(act, seed) end
...
function GEntity:SendViewModelMatchingSequence(seq) end
...
function GEntity:SequenceDuration(seqid) end
...
function GEntity:SetAbsVelocity(velocity) end
...
function GEntity:SetAngles(angles) end
...
function GEntity:SetAnimTime(time) end
...
function GEntity:SetAnimation(playerAnim) end
...
function GEntity:SetBodyGroups(subModelIds) end
...
function GEntity:SetBodygroup(bodyGroupId, subModelId) end
...
function GEntity:SetBoneController(boneControllerID, value) end
...
function GEntity:SetBoneMatrix(boneid, matrix) end
...
function GEntity:SetBonePosition(bone, pos, ang) end
...
function GEntity:SetCollisionBounds(mins, maxs) end
...
function GEntity:SetColor(color) end
...
function GEntity:SetCreator(ply) end
...
function GEntity:SetCustomCollisionCheck(enable) end
...
function GEntity:SetCycle(value) end
...
function GEntity:SetElasticity(elasticity) end
...
function GEntity:SetEntity(name, entity) end
...
function GEntity:SetFlexWeight(flex, weight) end
...
function GEntity:SetFriction(friction) end
...
function GEntity:SetGravity(multiplier) end

--- Sets the ground the entity is standing on.
--- @param ground GEntity @The ground entity.
function GEntity:SetGroundEntity(ground) end
...
function GEntity:SetIK(useIK) end
...
function GEntity:SetKeyValue(key, value) end
...
function GEntity:SetLOD(lod) end
...
function GEntity:SetLagCompensated(enable) end
...
function GEntity:SetLayerAutokill(layerID, autoKill) end
...
function GEntity:SetLayerBlendIn(layerID, blendIn) end
...
function GEntity:SetLayerWeight(layerID, weight) end
...
function GEntity:SetLocalPos(pos) end
...
--- @param velocity GVector @The new velocity to set.
function GEntity:SetLocalVelocity(velocity) end
...
function GEntity:SetMaterial(materialName) end
...
function GEntity:SetMaxHealth(maxhealth) end
...
function GEntity:SetMaxYawSpeed(maxyaw) end
...
function GEntity:SetModel(modelName) end
...
function GEntity:SetModelName(modelname) end
...
function GEntity:SetModelScale(scale, deltaTime) end
...
function GEntity:SetMoveCollide(moveCollideType) end
...
function GEntity:SetMoveParent(Parent) end
...
function GEntity:SetMoveType(movetype) end
...
function GEntity:SetNPCClass(classification) end
...
function GEntity:SetNW2Angle(key, value) end
...
function GEntity:SetNW2Bool(key, value) end
...
function GEntity:SetNW2Entity(key, value) end
...
function GEntity:SetNW2Float(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value number @The value to set
function GEntity:SetNW2Int(key, value) end
...
function GEntity:SetNW2String(key, value) end
...
function GEntity:SetNW2Var(key, value) end
...
function GEntity:SetNW2VarProxy(key, callback) end
...
function GEntity:SetNW2Vector(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value GAngle @The value to set
function GEntity:SetNWAngle(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value boolean @The value to set
function GEntity:SetNWBool(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value GEntity @The value to set
function GEntity:SetNWEntity(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value number @The value to set
function GEntity:SetNWFloat(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value number @The value to set
function GEntity:SetNWInt(key, value) end
...
function GEntity:SetNWString(key, value) end
...
function GEntity:SetNWVarProxy(key, callback) end
...
function GEntity:SetNetworkKeyValue(key, value) end
...
function GEntity:SetNetworkOrigin(origin) end
...
--- @return boolean @Whether a network variable was set successfully
function GEntity:SetNetworkVarsFromMapInput(name, param) end
...
--- @param key string @The key to associate the value with
--- @param value GAngle @The value to set
function GEntity:SetNetworked2Angle(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value boolean @The value to set
function GEntity:SetNetworked2Bool(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value GEntity @The value to set
function GEntity:SetNetworked2Entity(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value number @The value to set
function GEntity:SetNetworked2Float(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value number @The value to set
function GEntity:SetNetworked2Int(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value string @The value to set, up to 511 characters.
function GEntity:SetNetworked2String(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value any @The value to set
function GEntity:SetNetworked2Var(key, value) end
...
--- @param callback function @The function to be called when the NW2Var changes
function GEntity:SetNetworked2VarProxy(name, callback) end
...
--- @param key string @The key to associate the value with
--- @param value GVector @The value to set
function GEntity:SetNetworked2Vector(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value? GAngle @The value to set
function GEntity:SetNetworkedAngle(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value? boolean @The value to set
function GEntity:SetNetworkedBool(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value? GEntity @The value to set
function GEntity:SetNetworkedEntity(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value? number @The value to set
function GEntity:SetNetworkedFloat(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value? number @The value to set
function GEntity:SetNetworkedInt(key, value) end
...
function GEntity:SetNetworkedNumber(index, number) end
...
--- @param key string @The key to associate the value with
--- @param value? string @The value to set
function GEntity:SetNetworkedString(key, value) end
...
--- @param key string @The key to associate the value with
--- @param value any @The value to set
function GEntity:SetNetworkedVar(key, value) end
...
--- @param callback function @The function to be called when the NWVar changes
function GEntity:SetNetworkedVarProxy(name, callback) end
...
--- @param key string @The key to associate the value with
--- @param value? GVector @The value to set
function GEntity:SetNetworkedVector(key, value) end
...
function GEntity:SetNextClientThink(nextthink) end
...
function GEntity:SetNoDraw(shouldNotDraw) end
...
function GEntity:SetParent(parent, attachmentOrBoneId) end
...
function GEntity:SetParentPhysNum(bone) end
...
function GEntity:SetPersistent(persist) end
...
function GEntity:SetPhysConstraintObjects(Phys1, Phys2) end
...
function GEntity:SetPhysicsAttacker(ent, timeLimit) end
...
function GEntity:SetPlaybackRate(fSpeed) end
...
function GEntity:SetPos(position) end
...
function GEntity:SetPoseParameter(poseName, poseValue) end
...
function GEntity:SetPredictable(setPredictable) end
...
function GEntity:SetPreventTransmit(player, stopTransmitting) end
...
function GEntity:SetRagdollAng(boneid, pos) end
...
function GEntity:SetRagdollBuildFunction(builder) end
...
function GEntity:SetRenderBounds(mins, maxs, add) end
...
--- @param add? GVector @If defined, adds this vector to maxs and subtracts this vector from mins.
function GEntity:SetRenderBoundsWS(mins, maxs, add) end
...
function GEntity:SetRenderClipPlane(planeNormal, planePosition) end

--- Enables the use of clipping planes to "cut" objects.
--- @param enabled boolean @Enable or disable clipping planes
function GEntity:SetRenderClipPlaneEnabled(enabled) end
...
function GEntity:SetRenderFX(renderFX) end

--- Sets the render mode of the entity.
--- @param renderMode number @New render mode to set, see Enums/RENDERMODE.
function GEntity:SetRenderMode(renderMode) end
...
function GEntity:SetRenderOrigin(newOrigin) end
...
function GEntity:SetSaveValue(name, value) end
...
--- For custom scripted entities you will want to apply example from ENTITY:Think to make animations work.
--- @param sequence number @The sequence to play
function GEntity:SetSequence(sequence) end
...
function GEntity:SetShouldPlayPickupSound(playsound) end
...
function GEntity:SetShouldServerRagdoll(serverragdoll) end
...
function GEntity:SetSkin(skinIndex) end

--- Sets the solidity of an entity.
--- @param solid_type number @The solid type
function GEntity:SetSolid(solid_type) end
...
function GEntity:SetSolidFlags(flags) end
...
function GEntity:SetSpawnEffect(spawnEffect) end
...
function GEntity:SetSpawnFlags(flags) end
...
function GEntity:SetSubMaterial(index, material) end
...
function GEntity:SetSurroundingBounds(min, max) end
...
function GEntity:SetSurroundingBoundsType(bounds) end
...
function GEntity:SetTransmitWithParent(onoff) end
...
function GEntity:SetTrigger(maketrigger) end
...
function GEntity:SetUnFreezable(freezable) end
...
function GEntity:SetUseType(useType) end
...
function GEntity:SetVar(key, value) end
...
--- @param velocity GVector @The new velocity to set.
function GEntity:SetVelocity(velocity) end
...
function GEntity:SetWeaponModel(viewModel, weapon) end
...
function GEntity:SetupBones() end
...
function GEntity:SetupPhonemeMappings(fileRoot) end
...
function GEntity:SkinCount() end
...
function GEntity:SnatchModelInstance(srcEntity) end
...
function GEntity:StartLoopingSound(sound) end
...
function GEntity:StopParticleEmission() end
...
function GEntity:StopParticlesWithNameAndAttachment(name, attachment) end
...
function GEntity:StopSound(sound) end
...
function GEntity:TakeDamage(damageAmount, attacker, inflictor) end
...
function GEntity:TestPVS(testPoint) end
...
function GEntity:TranslateBoneToPhysBone(boneID) end
...
function GEntity:TranslatePhysBoneToBone(physNum) end

--- Updates positions of bone followers created by Entity:CreateBoneFollowers.
--- This should be called every tick.
--- ℹ **NOTE**: This function only works on `anim`, `nextbot` and `ai` type entities.
function GEntity:UpdateBoneFollowers() end
...
function GEntity:UpdateShadow() end
...
function GEntity:Use(activator, caller, useType, value) end
...
function GEntity:UseClientSideAnimation() end
...
function GEntity:UseTriggerBounds(enable, boundSize) end
...
function GEntity:ViewModelIndex() end
...
function GEntity:Visible(target) end
...
function GEntity:Weapon_SetActivity(act, duration) end
...
function GEntity:Weapon_TranslateActivity(act) end
...
function GEntity:WorldToLocal(wpos) end
...
function GEntity:WorldToLocalAngles(ang) end

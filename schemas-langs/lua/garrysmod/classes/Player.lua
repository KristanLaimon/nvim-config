...
function GPlayer:AccountID() end
...
function GPlayer:AddCleanup(type, ent) end
...
function GPlayer:AddPlayerOption(name, timeout, vote_callback, draw_callback) end
...
function GPlayer:AddVCDSequenceToGestureSlot(slot, sequenceId, cycle, autokill) end
...
function GPlayer:AnimRestartGesture(slot, activity, autokill) end

--- Restarts the main animation on the player, has the same effect as calling Entity:SetCycle( 0 ).
function GPlayer:AnimRestartMainSequence() end
...
function GPlayer:AnimSetGestureSequence(slot, sequenceID) end
...
function GPlayer:AnimSetGestureWeight(slot, weight) end

--- Returns the player's armor.
--- @return number @The player's armor.
function GPlayer:Armor() end
...
function GPlayer:Ban(minutes, kick) end
...
function GPlayer:CanUseFlashlight() end
...
function GPlayer:ChatPrint(message) end
...
function GPlayer:CheckLimit(str) end
...
function GPlayer:ConCommand(command) end
...
function GPlayer:CreateRagdoll() end
...
function GPlayer:DisableWorldClicking(disable) end
...
function GPlayer:DoAnimationEvent(data) end
...
function GPlayer:DoAttackEvent() end
...
function GPlayer:DoCustomAnimEvent(event, data) end
...
function GPlayer:DoReloadEvent() end
...
function GPlayer:DropNamedWeapon(class, target, velocity) end
...
function GPlayer:EnterVehicle(vehicle) end
...
function GPlayer:EquipSuit() end

--- Forces the player off the current ladder if they are on one.
function GPlayer:ExitLadder() end
...
function GPlayer:ExitVehicle() end
...
function GPlayer:Freeze(frozen) end
...
function GPlayer:GetCount(type, minus) end
...
function GPlayer:GetCrouchedWalkSpeed() end
...
function GPlayer:GetCurrentCommand() end
...
function GPlayer:GetCurrentViewOffset() end
...
function GPlayer:GetDrivingEntity() end
...
function GPlayer:GetDrivingMode() end

--- Returns a player's duck speed (in seconds)
--- @return number @duckspeed
function GPlayer:GetDuckSpeed() end
...
function GPlayer:GetEntityInUse() end
...
function GPlayer:GetEyeTrace() end
...
function GPlayer:GetEyeTraceNoCursor() end

--- Returns the FOV of the player.
--- @return number @Field of view as a float
function GPlayer:GetFOV() end
...
function GPlayer:GetHullDuck() end
...
function GPlayer:GetInfo(cVarName) end
...
function GPlayer:GetInfoNum(cVarName, default) end

--- Returns the jump power of the player
--- @return number @Jump power
function GPlayer:GetJumpPower() end
...
function GPlayer:GetMaxSpeed() end
...
function GPlayer:GetObserverTarget() end
...
function GPlayer:GetPData(key, default) end
...
function GPlayer:GetPreferredCarryAngles(carryEnt) end
...
function GPlayer:GetPunchAngle() end
...
function GPlayer:GetRunSpeed() end
...
function GPlayer:GetShootPos() end
...
function GPlayer:GetSlowWalkSpeed() end
...
function GPlayer:GetStepSize() end
...
function GPlayer:GetSuitPower() end
...
function GPlayer:GetTimeoutSeconds() end
...
function GPlayer:GetTool(mode) end

--- Returns a player's unduck speed (in seconds)
--- @return number @unduck speed
function GPlayer:GetUnDuckSpeed() end
...
function GPlayer:GetUseEntity() end
...
function GPlayer:GetViewEntity() end
...
function GPlayer:GetViewModel(index) end
...
function GPlayer:GetViewOffset() end
...
function GPlayer:GetViewOffsetDucked() end

--- Returns players screen punch effect angle.
--- @return GAngle @The punch angle
function GPlayer:GetViewPunchAngles() end
...
function GPlayer:GetViewPunchVelocity() end
...
function GPlayer:GetVoiceVolumeScale() end
...
function GPlayer:GetWalkSpeed() end
...
function GPlayer:GetWeapon(className) end
...
function GPlayer:GetWeaponColor() end
...
function GPlayer:GetWeapons() end
...
function GPlayer:Give(weaponClassName, bNoAmmo) end
...
function GPlayer:HasGodMode() end
...
function GPlayer:HasWeapon(className) end
...
function GPlayer:IsDrivingEntity() end
...
function GPlayer:IsFullyAuthenticated() end
...
function GPlayer:IsSpeaking() end
...
function GPlayer:IsSuperAdmin() end
...
function GPlayer:IsTimingOut() end
...
function GPlayer:IsWorldClicking() end
...
function GPlayer:IsWorldClickingDisabled() end
...
function GPlayer:KeyDown(key) end

--- Gets whether a key was down one tick ago.
--- @param key number @The key, see Enums/IN
--- @return boolean @Is key down ?
function GPlayer:KeyDownLast(key) end
...
function GPlayer:LocalEyeAngles() end
...
function GPlayer:OwnerSteamID64() end
...
function GPlayer:PacketLoss() end
...
function GPlayer:PhysgunUnfreeze() end
...
function GPlayer:PickupObject(entity) end
...
function GPlayer:PickupWeapon(wep, ammoOnly) end

--- Returns the player's ping to server.
--- @return number @The player's ping.
function GPlayer:Ping() end
...
function GPlayer:PlayStepSound(volume) end
...
function GPlayer:PrintMessage(type, message) end

--- Removes all ammo from a certain player
function GPlayer:RemoveAllAmmo() end

--- Removes all weapons and ammo from the player.
function GPlayer:RemoveAllItems() end
...
function GPlayer:RemoveAmmo(ammoCount, ammoName) end
...
function GPlayer:RemovePData(key) end

--- Strips the player's suit item.
function GPlayer:RemoveSuit() end

--- Resets both normal and duck hulls to their default values.
function GPlayer:ResetHull() end
...
function GPlayer:Say(text, teamOnly) end
...
function GPlayer:ScreenFade(flags, color, fadeTime, fadeHold) end
...
function GPlayer:SelectWeapon(className) end
...
function GPlayer:SendHint(name, delay) end
...
function GPlayer:SendLua(script) end
...
function GPlayer:SetArmor(amount) end
...
function GPlayer:SetAvoidPlayers(avoidPlayers) end
...
function GPlayer:SetCanWalk(canWalk) end
...
function GPlayer:SetCanZoom(canZoom) end
...
function GPlayer:SetCrouchedWalkSpeed(speed) end
...
function GPlayer:SetCurrentViewOffset(viewOffset) end
...
function GPlayer:SetDSP(dspEffectId, fastReset) end

--- Sets a player's death count
--- @param deathCount number @Number of deaths (positive or negative)
function GPlayer:SetDeaths(deathCount) end
...
function GPlayer:SetDuckSpeed(duckSpeed) end
...
function GPlayer:SetEyeAngles(angle) end
...
function GPlayer:SetHands(hands) end
...
function GPlayer:SetHoveredWidget(widget) end
...
function GPlayer:SetHull(mins, maxs) end
...
function GPlayer:SetHullDuck(mins, maxs) end
...
function GPlayer:SetJumpPower(jumpPower) end
...
function GPlayer:SetLadderClimbSpeed(speed) end
...
function GPlayer:SetLaggedMovementValue(timescale) end
...
function GPlayer:SetLastHitGroup(hitgroup) end
...
function GPlayer:SetMaxArmor(maxarmor) end
...
function GPlayer:SetNoCollideWithTeammates(shouldNotCollide) end
...
function GPlayer:SetNoTarget(visibility) end
...
function GPlayer:SetObserverMode(mode) end
...
function GPlayer:SetPData(key, value) end
...
function GPlayer:SetPlayerColor(Color) end
...
function GPlayer:SetPressedWidget(pressedWidget) end
...
function GPlayer:SetRenderAngles(ang) end
...
function GPlayer:SetRunSpeed(runSpeed) end
...
function GPlayer:SetSlowWalkSpeed(speed) end
...
function GPlayer:SetStepSize(stepHeight) end

--- Sets the player's HEV suit power.
--- 🦟 **BUG**: [This will only work for the local player when used clientside.](https://github.com/Facepunch/garrysmod-issues/issues/3449)
--- @param power number @The new suit power.
function GPlayer:SetSuitPower(power) end
...
function GPlayer:SetSuppressPickupNotices(doSuppress) end
...
function GPlayer:SetViewEntity(viewEntity) end
...
function GPlayer:SetViewOffset(viewOffset) end
...
function GPlayer:SetViewPunchVelocity(punchVel) end
...
function GPlayer:SetVoiceVolumeScale(arg) end
...
function GPlayer:SetWalkSpeed(walkSpeed) end
...
--- @param Color GVector @This is the color to be set
function GPlayer:SetWeaponColor(Color) end
...
function GPlayer:SetupHands(ent) end
...
function GPlayer:ShouldDrawLocalPlayer() end
...
function GPlayer:SimulateGravGunPickup(ent, lightning) end
...
function GPlayer:Spectate(mode) end
...
function GPlayer:SpectateEntity(entity) end
...
function GPlayer:SprayDecal(sprayOrigin, sprayEndPos) end

--- Disables the sprint on the player.
function GPlayer:SprintDisable() end

--- Enables the sprint on the player.
function GPlayer:SprintEnable() end
...
function GPlayer:StartSprinting() end
...
function GPlayer:StartWalking() end
...
function GPlayer:SteamID64() end
...
function GPlayer:StopSprinting() end
...
function GPlayer:SwitchToDefaultWeapon() end
...
function GPlayer:TimeConnected() end
...
function GPlayer:TraceHullAttack(startPos, endPos, mins, maxs, damage, damageFlags, damageForce, damageAllNPCs) end
...
function GPlayer:UniqueIDTable(key) end
...
function GPlayer:ViewPunch(punchAngle) end
...
function GPlayer:ViewPunchReset(tolerance) end
...
function GPlayer:VoiceVolume() end

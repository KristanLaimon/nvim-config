...
function GNextBot:BecomeRagdoll(info) end
...
function GNextBot:BodyMoveXY() end

--- Clears this bot's last known area. See NextBot:GetLastKnownArea.
function GNextBot:ClearLastKnownArea() end
...
function GNextBot:FindSpot(type, options) end
...
function GNextBot:GetLastKnownArea() end
...
function GNextBot:GetMaxVisionRange() end
...
function GNextBot:HandleStuck() end
...
function GNextBot:IsAbleToSee(ent, useFOV) end
...
function GNextBot:MoveToPos(pos, options) end
...
function GNextBot:PlaySequenceAndWait(name, speed) end
...
function GNextBot:SetFOV(fov) end
...
function GNextBot:SetMaxVisionRange(range) end
...
function GNextBot:SetSolidMask(mask) end
...
function GNextBot:StartActivity(activity) end

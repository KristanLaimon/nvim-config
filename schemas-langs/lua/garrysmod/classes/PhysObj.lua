...
function GPhysObj:ApplyForceCenter(impulse) end
...
function GPhysObj:ApplyForceOffset(impulse, position) end
...
function GPhysObj:ApplyTorqueCenter(angularImpulse) end
...
function GPhysObj:CalculateForceOffset(impulse, position) end
...
function GPhysObj:CalculateVelocityOffset(impulse, position) end

--- Removes one of more specified flags.
--- @param flags number @Bitflag, see Enums/FVPHYSICS.
function GPhysObj:ClearGameFlag(flags) end
...
function GPhysObj:ComputeShadowControl(shadowparams) end
...
function GPhysObj:EnableCollisions(enable) end

--- Sets whenever the physics object should be affected by drag.
--- @param enable boolean @True to enable, false to disable.
function GPhysObj:EnableDrag(enable) end

--- Sets whether the PhysObject should be affected by gravity
--- @param enable boolean @True to enable, false to disable.
function GPhysObj:EnableGravity(enable) end
...
--- @param enable boolean @True to enable, false to disable.
function GPhysObj:EnableMotion(enable) end
...
function GPhysObj:GetFrictionSnapshot() end
...
function GPhysObj:GetIndex() end
...
function GPhysObj:GetMassCenter() end
...
function GPhysObj:GetMaterial() end
...
function GPhysObj:GetStress() end
...
function GPhysObj:GetVelocityAtPoint(point) end
...
function GPhysObj:IsMotionEnabled() end

--- Returns whenever the entity is able to move.
--- @return boolean @movable
function GPhysObj:IsMoveable() end
...
function GPhysObj:LocalToWorld(vecLocal) end
...
function GPhysObj:LocalToWorldVector(vecLocal) end

--- Prints debug info about the state of the physics object to the console.
function GPhysObj:OutputDebugInfo() end
...
function GPhysObj:RecheckCollisionFilter() end
...
function GPhysObj:RotateAroundAxis(dir, ang) end
...
function GPhysObj:SetAngleDragCoefficient(coefficient) end
...
function GPhysObj:SetAngleVelocity(angularVelocity) end
...
function GPhysObj:SetAngleVelocityInstantaneous(angularVelocity) end

--- Sets the angles of the physobject in degrees.
--- @param angles GAngle @The new angles of the physobject
function GPhysObj:SetAngles(angles) end
...
function GPhysObj:SetBuoyancyRatio(buoyancy) end

--- Sets the contents flag of the PhysObj.
--- @param contents ECONTENTS @The Enums/CONTENTS.
function GPhysObj:SetContents(contents) end
...
function GPhysObj:SetDamping(linearDamping, angularDamping) end

--- Modifies how much drag (air resistance) affects the object.
--- @param drag number @The drag coefficient
function GPhysObj:SetDragCoefficient(drag) end
...
function GPhysObj:SetInertia(angularInertia) end
...
function GPhysObj:SetMass(mass) end
...
function GPhysObj:SetMaterial(materialName) end
...
function GPhysObj:SetPos(position, teleport) end
...
function GPhysObj:SetVelocity(velocity) end

--- Sets the velocity of the physics object.
--- @param velocity GVector @The new velocity of the physics object.
function GPhysObj:SetVelocityInstantaneous(velocity) end
...
function GPhysObj:UpdateShadow(targetPosition, targetAngles, frameTime) end

--- Wakes the physics object, so that it will continue to simulate physics/gravity.
--- See PhysObj:Sleep for more information.
function GPhysObj:Wake() end
...
function GPhysObj:WorldToLocal(vec) end
...
--- @param vec GVector @A worldspace vector.
--- @return GVector @The resulting vector from the rotational transformation.
function GPhysObj:WorldToLocalVector(vec) end

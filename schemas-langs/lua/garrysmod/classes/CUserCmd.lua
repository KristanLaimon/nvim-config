...
function GCUserCmd:AddKey(key) end
...
function GCUserCmd:GetForwardMove() end
...
function GCUserCmd:IsForced() end
...
function GCUserCmd:KeyDown(key) end
...
function GCUserCmd:RemoveKey(button) end
...
function GCUserCmd:SelectWeapon(weapon) end
...
function GCUserCmd:SetButtons(buttons) end
...
function GCUserCmd:SetForwardMove(speed) end
...
function GCUserCmd:SetImpulse(impulse) end

--- Sets the scroll delta.
--- @param speed number @The scroll delta.
function GCUserCmd:SetMouseWheel(speed) end
...
function GCUserCmd:SetMouseX(speed) end
...
function GCUserCmd:SetMouseY(speed) end
...
--- @param speed number @The new speed to request.
function GCUserCmd:SetSideMove(speed) end
...
--- @param speed number @The new speed to request.
function GCUserCmd:SetUpMove(speed) end
...
function GCUserCmd:SetViewAngles(viewAngle) end
...
function GCUserCmd:TickCount() end

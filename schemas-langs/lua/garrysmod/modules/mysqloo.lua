...
function Query:wait(shouldSwap) end
...
--- @param err string
function Transaction.onError(tr, err) end
...
function Database:setMultiStatements(useMultiStatemets) end
...
--- @nodiscard
function Database:setCharacterSet(charSetName) end

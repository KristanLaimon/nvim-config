...
function ENT:AcceptInput(inputName, activator, caller, param) end
...
function ENT:AddOutputFromAcceptInput(name, data) end
...
--- @return boolean @Whether any outputs were added or not.
function ENT:AddOutputFromKeyValue(key, value) end
...
function ENT:CanEditVariables(ply) end
...
function ENT:OnRemove(fullUpdate) end
...
function ENT:OnTaskFailed(failCode, failReason) end
...
function ENT:OverrideMove(interval) end
...
function ENT:OverrideMoveFacing(interval, AILMG) end
...
function ENT:TranslateActivity(oldAct) end
...
function ENT:TranslateNavGoal(target, currentGoal) end
...
function ENT:TranslateSchedule(schedule) end

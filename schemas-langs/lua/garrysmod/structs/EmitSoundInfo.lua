...
--- @field SoundLevel? ESNDLVL @The sound's attenuation, a number between 0 (low) and 511 (high)
...
--- @field Flags? ESND @The bit flags of the played sound
--- @field Channel ECHAN @The sound's channel

...
function M.reload()
	package.loaded["plugins.krs.editor.tailwind_organizer"] = nil
	require("plugins.krs.editor.tailwind_organizer").setup()
...
function M.setup()
	...
	local ok, palette = pcall(require, "plugins.krs.tools.command_palette")

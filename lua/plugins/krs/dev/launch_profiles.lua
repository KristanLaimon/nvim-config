...
--
-- COLLABORATORS
--   plugins.krs.dev.tasks        Runs pre-launch tasks and terminal launches.
--   plugins.krs.ui.input_modal  Single-field prompts used by the form.
...
function M.run_profile(profile)
	...
	M.run_pre_launch_tasks(pre_tasks, function(success)
		...
		require("plugins.krs.dev.tasks").run_custom_command(cmd, profile.env or {})
	end)
end

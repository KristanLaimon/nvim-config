...
---
--- @example
--- local krs = require("krs.lib.krsnvim")
--- local fetch = krs.fetch
--- local json = krs.json
local M = {}

M.json = require("krs.lib.krsnvim.json")
M.yaml = require("krs.lib.krsnvim.yaml")
M.toml = require("krs.lib.krsnvim.toml")
M.terminal = require("krs.lib.krsnvim.terminal")
M.cli = require("krs.lib.krsnvim.cli")
M.fs = require("krs.lib.krsnvim.fs")
M.fetch = require("krs.lib.krsnvim.fetch")
M.wiki = require("krs.lib.krsnvim.wiki")
M.tests = require("krs.lib.krsnvim.tests")
M.console = require("krs.lib.krsnvim.console")
M.test = require("krs.lib.krsnvim.test")
M.describe = M.test.describe
M.expect = M.test.expect
M.it = M.test.it
M.async = require("krs.lib.krsnvim.async")
M.concurrent = M.async
M.parallel = M.async
M.krsnvimtranspiler = require("krs.lib.krsnvim.krsnvimtranspiler")
